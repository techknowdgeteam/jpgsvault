<?php
// copied_urls.php - Standalone debug script for JPGS Vault sync issues
...
echo "
    <div class='section'>
        ...
        <p><a href='copied_urls.php' style='background: #2196F3; color: white; padding: 10px 20px; text-decoration: none; border-radius: 4px;'>Refresh Debug</a></p>
    </div>
";
